    ...
    <main>
      ...
      <section className={styles.policy}>
        <div className='container'>
          ...
          <p>
            2.1. Обработка персональных данных осуществляется в интересах клиентов интернет-магазина “SodiumStore” и включает в себя следующие цели: - Информирование Пользователя посредством отправки электронных писем. - Заключение, исполнение и прекращение гражданско-правовых договоров. - Предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте.
          </p>
          <p>
          ...
          <p>
            3.1. Оператор собирает следующие персональные данные: - ФИО клиента. - Контактный e-mail клиента.
          </p>
          ...
          <p>
            4.1. Оператор обрабатывает персональные данные на следующих правовых основаниях: - Согласие клиента на обработку его персональных данных. - Исполнение договора с клиентом.
          </p>
          ...
          <p>
            5.1. Оператор осуществляет следующие виды обработки персональных данных: - Сбор, запись, систематизация, накопление, хранение, уточнение (обновление, изменение), использование, распространение, обезличивание, блокирование, уничтожение.
          </p>
          <p>
          ...
          <p>
            6.1. Оператор обеспечивает точность персональных данных, их достаточность и актуальность по отношению к целям обработки.
          </p>
          <p>
